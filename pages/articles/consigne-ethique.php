...
// Title à remplir
$title = 'Consigne : le nouveau pari des marques de mode éthique';
...
<main id="article-001">
	<div class="conteneur">
		<div>
			<h1>Consigne : le nouveau pari des marques <span>de mode éthique</span></h1>
		</div>
		<section class="article">
			<div>
				<img src="<?= $root ?>img/header_art-001.png" alt="">
			</div>
			<div class="info">
				<div>
			...
			<article>
				...
				<div>
					<img src="<?=$root;?>img/article-001_joie.png" alt="">
				</div>
				<p>
					Comme un pied de nez au Black Friday, devenu synonyme d’incitation à la surconsommation, Hopaal, 1083, Atelier Unes et Panafrica ont choisi ce moment de l'année pour dire stop à la mode jetable et promouvoir dans leur collection le système de consigne.
				</p>
